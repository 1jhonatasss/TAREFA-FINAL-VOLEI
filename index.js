            ...
            <html lang="pt-br">
                <hear>
                    ...
                    <div class="container w-75 mb-5">
                            <form method="POST" action="/cadastroUsuario" class="row gx-3 border p-2">
                            <fieldset>
...
app.post("/cadastro",(requisicao, resposta) => {
    ...
    resposta.send("<p> Usuario cadastrado</p>");
    resposta.end();

});

app.listen(port, host, () => {
    console.log(`sevidor em execução http://${host}:${port}/`);
});